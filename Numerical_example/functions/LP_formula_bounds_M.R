...
compute_LP_formula_bounds_no_S <- function(df, monotonicity_constraint = "NO") {
  ...
  if(monotonicity_constraint=="NO"){
   ...
   if(monotonicity_constraint=="positive_M"){
     ...
     #VE0
     ve0_upper <- 1 - (probs$p_01 * exps$EY_10+probs$p_11 * 0)/ (probs$p_00 * exps$EY_00+probs$p_10*exps$EY_01)
     ve0_lower <- 1 - (probs$p_01 * exps$EY_10 + probs$p_11 * exps$EY_11)/( probs$p_00 * exps$EY_00 + probs$p_10 * 0)
     
     # VE1
     ve1_upper<- 1 -(probs$p_01 * exps$EY_10 + probs$p_11 * exps$EY_11)/(probs$p_00 *1 + probs$p_10 * exps$EY_01)
     ve1_lower<- 1 -( probs$p_01 * 1 + probs$p_11 * exps$EY_11)/(probs$p_00 *exps$EY_00 + probs$p_10 * exps$EY_01)
     
     # VEt
     vet_upper <- 1 - (probs$p_01 *exps$EY_10 + probs$p_11 * exps$EY_11) / (probs$p_00 * exps$EY_00 + probs$p_10 * exps$EY_01)
     vet_lower <- 1 - (probs$p_01 * 1 + probs$p_11 * exps$EY_11) / (probs$p_00 * exps$EY_00 + probs$p_10 * 0)
